...
(function() {
  (angular.module('reitz')).factory('projectservice', function() {
    var CalcNormalDensity, CalculateDensity, Density, calculateVp, createJson, data, density, editdata, entitykeyNew, genearateJson, genrateId, guid, postdata, tempViscObject;
    ...
    createJson = function(data) {
      ...
      _.map(_.range(data.GasOperatingPoints.length), function(i) {
        return obj.GasDatas[0].GasOperatingPoints.push({
          $id: id().toString(),
